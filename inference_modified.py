    ...
    if args.generate_training_data:
        ...
        if args.prompts_path is None:
            ...
            for idx, row in df.iterrows():
                ...
                for sample_idx, im in enumerate(images):
                    im.save(
                        f"{output_folder}/{idx}_{sample_idx}.png"
                    )
...
if __name__ == "__main__":
    ...
    parser.add_argument('--prompts_path', type=str, default=None, help='CSV containing prompts for batch generation')
